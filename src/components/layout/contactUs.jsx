            ...
            <div className="ct-info-stack">
              {contactInfo.map((info, i) => (
                <a href={info.href} className="ct-info-card" key={i}>
                  ...
                  <svg viewBox="0 0 24 24" fill="none" stroke="rgba(44,62,80,0.2)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" width="16" height="16">
              ...
              {sent ? (
                <div className="ct-success">
                  <div className="ct-success-icon">
                    <svg viewBox="0 0 24 24" fill="none" stroke="rgba(237,228,212,0.95)" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" width="26" height="26">
                  ...
                  <button className="ct-success-btn" onClick={() => { setSent(false); setForm({ name: "", email: "", subject: "", message: "" }); }}>
                    Send Another
                ...
                <>
                  ...
                  <p className="ct-form-sub">Fill in the form below and we'll respond as soon as possible.</p>
