...
function ApplicationsTab({ filtered, filter, setFilter, search, setSearch }) {
  return (
    <div>
      ...
      <div style={{ background:"#fff", borderRadius:14, border:"1px solid #E2E8F0", overflow:"hidden" }}>
        <table style={{ width:"100%", borderCollapse:"collapse" }}>
          ...
          <tbody>
            {filtered.map((shop, i) => (
              <ApplicationRow key={shop.id} shop={shop} index={i} />
            ))}
          </tbody>
        </table>
      </div>
...
// ApplicationRow needs setSelected from context — use a render prop pattern
// by passing setSelected down through ApplicationsTab instead
...
export default function AdminDashboard() {
  ...
  // Two separate search states — shop search and payment search
  ...
  // Filtered lists use debounced values
  ...
  // Sidebar stays inside — no search inputs here
  const Sidebar = () => (
