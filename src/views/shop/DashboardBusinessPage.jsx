...
export default function ShopDashboardBusiness() {
  ...
  // ── Monthly breakdown computed from real quotations ──
      ...
      <div style={{ display:"flex", justifyContent:"space-between", alignItems:"center", marginBottom:16 }}>
        ...
        <div style={{ position:"relative" }}>
          <input placeholder="Search projects..." value={searchQuery} onChange={e => setSearchQuery(e.target.value)}
            style={{ paddingLeft:32, paddingRight:14, paddingTop:8, paddingBottom:8, border:"1px solid #E2E8F0", borderRadius:8, fontSize:12, fontFamily:"'Inter', sans-serif", outline:"none", width:220 }} />
  ...
  const FeaturedPlacement = () => (
    <div>
      ...
      <div style={{ background:"linear-gradient(135deg,#F5F3FF,#EDE9FE)", borderRadius:14, border:"1px solid #DDD6FE", padding:"20px 24px" }}>
        ...
        <div style={{ fontSize:12.5, color:"#6D28D9", lineHeight:1.6 }}>All promotional features above are included in your Business plan at no extra cost. They renew automatically with your annual subscription.</div>
      </div>
    </div>
  );
  ...
  /* ── Billing (real data from Firestore) ── */
  const Billing = () => (
    <div>
      ...
      <div style={{ background:"#fff", borderRadius:14, border:"1px solid #E2E8F0", padding:"24px" }}>
        <div style={{ display:"flex", justifyContent:"space-between", alignItems:"flex-start", marginBottom:20, paddingBottom:20, borderBottom:"1px solid #F1F5F9" }}>
          <div>
            ...
            <div style={{ fontSize:26, fontWeight:900, color:"#7C3AED", fontFamily:"'Lora', Georgia, serif" }}>₱4,499<span style={{ fontSize:13, fontWeight:400, color:"#94A3B8" }}>/year</span></div>
          </div>
          <PlanBadge />
        </div>
        {shop && [
